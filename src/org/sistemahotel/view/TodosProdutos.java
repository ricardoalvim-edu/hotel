 ...
 * @author ricar
 */
public class TodosProdutos extends JanelaAbstrata<Produto> {
    ...
    public TodosProdutos() {
        initComponents();
        this.controle = new ControllerProduto();
        currentView = controle.exibePrimeiro();
        exibeProdutos();
    }

    public void exibeProdutos() {
        List<Produto> produtos = controle.listAll();
        Object obj[][] = new Object[produtos.size()][3];
        int i = 0;
        for (Produto p : produtos) {
            for (int j = 0; j < 3; j++) {
                if (j == 0) {
                    ...
                    obj[i][j] = p.getIdcategoria().getNomeCategoria();
                }
            }
            i++;
        }
    ...
    public void pesquisar(){
        ...
        List<Produto> produtos = controle.getByName(pesquisa, Produto.class, "nome" , ".findByNome");
    ...
    private void inputPesquisaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_inputPesquisaKeyTyped
        // TODO add your handling code here:
        pesquisar();
    }//GEN-LAST:event_inputPesquisaKeyTyped
