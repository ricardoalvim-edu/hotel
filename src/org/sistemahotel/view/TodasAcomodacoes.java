...
public class TodasAcomodacoes extends JanelaAbstrata<Acomodacao> {
    ...
    public void exibeAcomodacoes() {
        List<Acomodacao> acomodacoes = controle.listAll();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Relatório de Acomodações");
    ...
    public void pesquisar(){
        ...
        List<Acomodacao> acomodacoes = controle.getByName(pesquisa, Acomodacao.class, "nome" , ".findByCategoria");
