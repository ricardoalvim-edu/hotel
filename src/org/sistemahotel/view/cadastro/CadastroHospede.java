...
public class CadastroHospede extends JanelaAbstrata<Hospede> {
    ...
    private void initComponents() {
        ...
        tfdataNascimento = new javax.swing.JFormattedTextField(mascaraNasc());
        ...
        PanelContatoLayout.setHorizontalGroup(
            ...
            .addGroup(PanelContatoLayout.createSequentialGroup()
                .addGap(32, 32, 32)
                .addComponent(jbAdicionar, javax.swing.GroupLayout.PREFERRED_SIZE, 206, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public MaskFormatter mascaraNasc(){
        try{
           MaskFormatter mascara = new MaskFormatter("##/##/####");
           return mascara; 
        }catch(Exception ex){
            JOptionPane.showMessageDialog(null, "Falha na mascara!");
        }
        return null;  
    }
    /**
