...
public class TodosProdutos extends JanelaAbstrata<Produto> {
    ...
    public void exibeProdutos() {
        List<Produto> produtos = controle.listarTudo();
    ...
    public void pesquisar(){
        ...
        for (Produto p : produtos) {
            for (int j = 0; j < 3; j++) {
                ...
                if (pesquisa.contains(p.getNome()) || 
                        pesquisa.equalsIgnoreCase(p.getNome()) ||
                        (p.getNome().toLowerCase().contains(pesquisa.toLowerCase()))&& 
